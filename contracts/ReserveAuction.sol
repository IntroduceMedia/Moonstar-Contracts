...
contract ReserveAuction is ReentrancyGuard {
        ...
        auctionNotExpired(tokenId)
    {
        ...
        // Deposit token 
        require(IBEP20(paymentTokenAddress).transferFrom(msg.sender, address(this),  amount));
    ...
    function transferPaymentToken(address to, uint256 value) private {
        require(IBEP20(paymentTokenAddress).transfer(to, value));
    }
