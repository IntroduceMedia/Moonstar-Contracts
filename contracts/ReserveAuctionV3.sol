...
// File: @openzeppelin/contracts-BNBereum-package/contracts/math/SafeMath.sol
...
contract ReserveAuctionV3 is ReentrancyGuard {
        ...
        auctionComplete(tokenId)
    {
        ...
        if (CreatorFeePercent > 0) {
            ...
            transferBNBOrWBNB(Creator, CreatorAmount);
        ...
        if (nftCreator == fundsRecipient) {
            transferBNBOrWBNB(nftCreator, amount);
        } else {
            ...
            transferBNBOrWBNB(nftCreator, creatorAmount);
            // Send the remainder of the amount to the funds recipient.
            transferBNBOrWBNB(fundsRecipient, amount.sub(creatorAmount));
        }
